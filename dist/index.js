...
__export(src_exports, {
  CharAllowanceMode: () => CharAllowanceMode,
  INVALID_CHARS: () => INVALID_CHARS,
  INVALID_CHARS_CI: () => INVALID_CHARS_CI,
  INVALID_CHARS_CI_WITH_DOTS: () => INVALID_CHARS_CI_WITH_DOTS,
  INVALID_CHARS_CI_WITH_SPECIALS: () => INVALID_CHARS_CI_WITH_SPECIALS,
  INVALID_CHARS_WITH_DOTS: () => INVALID_CHARS_WITH_DOTS,
  INVALID_CHARS_WITH_SPECIALS: () => INVALID_CHARS_WITH_SPECIALS,
  cleanKey: () => cleanKey,
  cleanKeyCI: () => cleanKeyCI,
  cleanKeyCIWithDots: () => cleanKeyCIWithDots,
  cleanKeyCIWithSpecials: () => cleanKeyCIWithSpecials,
  cleanKeySimple: () => cleanKeySimple,
  cleanKeySimpleCI: () => cleanKeySimpleCI,
  cleanKeySimpleCIWithDots: () => cleanKeySimpleCIWithDots,
  cleanKeySimpleCIWithSpecials: () => cleanKeySimpleCIWithSpecials,
  cleanKeySimpleWithDots: () => cleanKeySimpleWithDots,
  cleanKeySimpleWithSpecials: () => cleanKeySimpleWithSpecials,
  cleanKeyWithDots: () => cleanKeyWithDots,
  cleanKeyWithSpecials: () => cleanKeyWithSpecials,
  parameterize: () => parameterize,
  parameterizeAndClean: () => parameterizeAndClean,
  processedSafeKey: () => processedSafeKey,
  safeKeyToOriginal: () => safeKeyToOriginal
});
...
function run(s, opts = {}) {
  ...
  const valueTrimmed = trimEdgeDashes ? (0, import_es_toolkit.trim)(value, "-") : value;
